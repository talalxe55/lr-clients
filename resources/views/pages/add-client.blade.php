                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select required class="text-capitalize form-select border border-2 p-2"
                                        placeholder="Client Type" id="floatingTextarea2" name="type"
                                        rows="4" cols="50">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select required class="text-capitalize form-select border border-2 p-2"
                                        placeholder="Client Type" id="floatingTextarea2" name="status"
                                        rows="4" cols="50">
                                        <option disabled>Select Status</option>
                                        @foreach ($status as $st)
                                        <option class="text-capitalize" value="{{$st->id}}">{{$st->name}}</option>
                                        @endforeach
                                    </select>
                                        @error('status')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="floatingTextarea2">Live Date</label>
                                    {{-- <input type="date" name="live_date" class="form-control border border-2 p-2"> --}}
                                    <input type="text" placeholder="Select Date.." name="live_date" class="flatpickr flatpickr-input active mb-4 live_date form-control border border-2 p-2">
                                        @error('live_date')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                        @enderror
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="floatingTextarea2">Cancel Date</label>
                                    {{-- <input type="date" name="live_date" class="form-control border border-2 p-2"> --}}
                                    <input type="text" placeholder="Select Date.." name="cancel_date" class="flatpickr flatpickr-input active mb-4 live_date form-control border border-2 p-2" >
                                        @error('cancel_date')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                        @enderror
                                </div>
                                ...
                                <div class="mb-3 col-md-12">
                                    <label for="floatingTextarea2">Services</label>
                                    {{-- <input class="form-control border border-2 p-2"
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="services[]" value="{{$service->id}}">
