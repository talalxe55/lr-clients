                        ...
                        <form method='POST' action='{{ route('user-profile') }}'>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input readonly type="email" name="email" class="form-control border border-2 p-2" value='{{ old('email', auth()->user()->email) }}'>
                                    @error('email')
                                ...
                                {{-- <div class="mb-3 col-md-12">
                                    ...
                                    <select class="form-control border border-2 p-2"
                                        placeholder=" User Role" id="floatingTextarea2" name="about"
                                        rows="4" cols="50">{{ old('about', auth()->user()->about) }}
                                    <option></option>
                                    </select>
                                        @error('role')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
