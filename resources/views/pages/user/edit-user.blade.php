                ...
                <div class="row gx-4 mb-2">
                    ...
                    <div class="col-auto my-auto">
                        <div class="h-100">
                            ...
                            <p class="text-capitalize mb-0 font-weight-normal text-sm">
                                {{$user->getRoleNames()[0]}}
                            </p>
                        </div>
                    </div>
                        ...
                        <form method='POST' action='{{ route('update.user', $user->id) }}'>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input readonly type="number" name="id" class="form-control border border-2 p-2" value='{{ $user->id }}'>
                                    @error('id')
                                ...
                                <div class="mb-3 col-md-12">
                                    <label for="floatingTextarea2">Role</label>
                                    <select required class="form-control border border-2 p-2"
                                        placeholder="User Role" id="floatingTextarea2" name="role"
                                        rows="4" cols="50">
                                        @foreach ($roles as $role)
                                        @if($role->name === $user->getRoleNames()[0])
                                        <option class="text-capitalize" selected value="{{$role->name}}">{{$role->name}}</option>
                                        @else
